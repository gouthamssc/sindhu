...
public class Histogram extends JPanel {
    ...
    public Histogram(double[] values, String[] labels, Color[] colors, String title) {
        this.labels = labels;
        this.values = values;
        this.colors = colors;
        this.title = title;
    ...
    public static void main(String[] args) {
        ...
        double[] values = new double[]{60,70,70,75,65};
        String[] labels = new String[]{"Goutham","kiran","CR","Sindhu","Pragnavi"};
        ...
        Histogram bc = new Histogram(values, labels, colors, title);
